...
var cloneData = _toConsumableArray(_data.default);

var newRank = cloneData.length + 1;
var sortMethod; // 注册模块

var patch = (0, _snabbdom.init)([_style.default, _class.default, _eventlisteners.default]);
var app = document.querySelector('#app'); // 创建 container 

function view() {
  return (0, _snabbdom.h)('div#container', {
    style: {
      color: '#fff',
      padding: '15px 25px'
    }
  }, [(0, _snabbdom.h)('h1', "Top 10 movies"), (0, _snabbdom.h)('div.header', {
    style: {
      height: '48px',
      lineHeight: '48px',
      marginTop: '10px'
    }
  }, [(0, _snabbdom.h)('span.btns-group', {
    style: {
      float: 'left'
    }
  }, ['Sort By：', (0, _snabbdom.h)('a.btn.rank', {
    class: {
  ...
  }, 'Description')]), (0, _snabbdom.h)('a.btn.add', {
    style: {
      float: 'right'
    },
    on: {
  ...
  }, 'Add')]), (0, _snabbdom.h)('div.main-lists', {
    style: {
      clear: 'both'
    }
...
var oldVnode = patch(app, view()); // 新vnode 替换 旧vnode，更新视图
...
function createRow(movie) {
  return (0, _snabbdom.h)('div.item', {
    key: movie.rank,
    style: {}
  }, [(0, _snabbdom.h)('div.rank', {
    style: {
      width: '10%',
      fontWeight: 'bold'
    }
  }, movie.rank), (0, _snabbdom.h)('div.title', {
    style: {
      width: '30%'
    }
  }, movie.title), (0, _snabbdom.h)('div.desc', {
    style: {
      width: '60%'
    }
  }, movie.desc), (0, _snabbdom.h)('a.del', {
    on: {
...
function addMovieFn() {
  ...
  var m = _data.default[Math.floor(Math.random() * 10)];
